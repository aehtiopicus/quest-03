...
import HeroContentImage from 'src/assets/images/Dashboard1_hero_content.png';
import Avatar1Image from 'src/assets/images/Dashboard1_Avatar.png';
import Rectangle9Image from 'src/assets/images/Dashboard1_Rectangle_9.png';
import { styled } from '@mui/material/styles';
import Sidebar2 from 'src/components/Sidebar2/Sidebar2';
import Stat4 from 'src/components/Stat4/Stat4';
import Stat6 from 'src/components/Stat6/Stat6';
import EventList from 'src/components/EventList/EventList';
import Table3 from 'src/components/Table3/Table3';
        ...
        <Content >
          <TopContent >
            <LeftContent >
              <Sec1 >
                <Hero >
                  <HeroContent  src={HeroContentImage} alt={"hero content"}/>
                </Hero>
              </Sec1>
              <Frame43 >
                <Stat41   />
                  ...
                  <Frame6 >
                    <RightSide2 >
                      <Frame5 >
                        ...
                        <Rectangle9  src={Rectangle9Image} alt={"Rectangle 9"}/>
                      </Frame5>
                    </RightSide2>
                  </Frame6>
                </Content1>
